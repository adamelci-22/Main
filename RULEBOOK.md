...
**Friday 2026-08-28, 10:03 ET: position open — AFRM, 2 sh @ $85.4899, stop $83.35 (-2.50%), target ~$88.70 (+3.75%).** Entered at the 10:00 management checkpoint (flat, C gate stack), full details and the pre-commit in E5. Cash after entry ~$63.77 settled, buying power reflects the open position. Next check: 10:15 management (hold, ratchet the stop per B2).
