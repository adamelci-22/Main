...
**Monday 2026-08-31, 9:42 ET: position open — GUSH, 5 sh @ $45.6699, stop $44.53 (-2.50%), target ~$47.38 (+3.75%).** Entered at 9:40 on a broad, clean Energy-sector move (US-Iran strikes, crude spike) — full gate-stack detail in E5. First live entry under v3.48's incremental B6 tracking. Next check: 10:00 management (hold, ratchet the stop per B2).
