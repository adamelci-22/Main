...
**Monday 2026-09-21, 9:00 research — fourth live day under v3.71-v3.79 (Core Ten, proxy-gated RVOL-ORB-ATR-with-RVOL-fallback, 11:00 close, daily trade cap, $250 floor).** Friday 9/18's full session (2 trades, both on the same TLT/TMV signal — TZA-style scratch then a real winner, net +$1.52; plus a five-checkpoint stretch where an isolated TLT volume spike blocked a broader multi-proxy move from ever being checked, see E6) archived in `archive/trades.csv` and git history — not restated here per D3's "authoritative log, not a third copy" discipline.

- **A1 checks: loss streak 0 of 3** (Friday's second TMV trade was a real winner, resetting/keeping the streak at 0). **Position: flat, no resting orders** (`get_equity_positions` empty, zero non-terminal orders via `get_equity_orders`). **Daily trade count today: 0 of 3** (fresh day).
- **Account state:** total value/cash/buying power **$503.86** (`get_portfolio`), unchanged from Friday's close (no weekend deposit/withdrawal). **Deposited capital recomputed**: `$503.86 − $3.90 (all-time realized P&L, get_realized_pnl) − $0 unrealized` = **$499.96**, unchanged. **Floor: $250.00** (50% of deposited), confirmed live this checkpoint.
- **Headlines/macro:** Futures broadly higher to start the week — Dow +0.77%, S&P +0.70%, Nasdaq +1.12% — as oil prices retreat for a fourth straight day (the longest such streak in three months), easing inflation concerns. Markets coming off last week's Fed hike and a volatile week; attention now turns to Trump hosting Xi at the White House this week (summit scheduled Sept. 24), with trade, tariffs, Taiwan, and AI expected to feature. Tech leading gains regionally. This session's own broker quotes corroborate the broadly bullish, oil-down picture (see next bullet) — unlike Friday, the search context and live quotes are internally consistent this time. ([Yahoo Finance](https://finance.yahoo.com/markets/live/stock-market-today-monday-september-21-dow-sp-500-nasdaq-080214605.html), [Bloomberg](https://www.bloomberg.com/news/articles/2026-09-20/us-stock-futures-up-ahead-of-talks-dollar-steady-markets-wrap))
- **Pre-market prices, the ten proxies — C1's actual gate surface, none of this is a decision yet (RVOL/ORB can't complete before 9:45), vs Friday's official close:** QQQ $727.94 (+0.90%) · SPY $766.36 (+0.61%) · SOXX $545.52 (+2.33%, by far the firmest mover) · IWM $286.23 (+0.75%) · XLF $56.01 (+0.26%) · XLE $63.28 (-1.60%, the clear negative, oil retreating) · GLD $399.75 (-0.35%) · TLT $81.66 (+0.50%) · XBI $158.03 (+0.84%) · XRT $81.92 (-0.13%, bid/ask $81.67/$84.16 — unusually wide again, same thin-liquidity flag as prior sessions). A genuine broad risk-on rally — nine of ten proxies with a real move, SOXX standing out on chip strength, XLE the lone clear decliner on falling oil.
- **Pre-market context on the twenty leveraged tickers (not gated, informational only, C4):** TQQQ $74.86/SQQQ $36.72 · UPRO $149.94/SPXU $34.63 · SOXL $132.44/SOXS $38.60 · TNA $63.30/TZA $43.87 · FAS $164.34/FAZ $34.51 (FAS spread wide pre-market) · ERX $107.79/ERY $9.01 (ERX spread wide) · UGL $50.48/GLL $22.68 · TMF $30.10/TMV $43.49 · LABU $269.74/LABD $7.13 · RETL $7.19/SZK $22.38 (SZK bid/ask $19.79/$24.96 — still thin, consistent with every prior session).
- Earnings: no after-close reporters overnight land on a Core Ten theme; the notable single-name item (Google's $463M EU fine) isn't a Core Ten instrument, noted for awareness only.
...
**9:30 observation**: A1 re-checked — loss streak still **0 of 3**, flat, no resting orders, daily trade count still **0 of 3**. **B6 opening-range tracker initialized on the ten proxies** — each proxy's 9:30 print is the baseline C1 step 2 will check the 9:45 breakout against, vs Friday's close: QQQ $728.67 (+1.00%) · SPY $766.57 (+0.64%) · SOXX $545.515 (+2.34%, firmest mover) · IWM $285.58 (+0.52%) · XLF $56.1299 (+0.48%) · XLE $63.48 (-1.29%) · GLD $399.71 (-0.36%) · TLT $81.675 (+0.52%) · XBI $157.51 (+0.50%) · XRT $82.345 (+0.38%). The broad rally held into the open — nine of ten proxies positive, SOXX standing out, XLE the lone decliner, consistent with pre-market. No decision made here — first real gate run is 9:45.

**9:45 — ENTRY. First trade of the day: TQQQ, bullish leg off QQQ, cleanest signal yet.** Fixed 9:30-9:45 opening range established: QQQ [727.820, 730.785] · SPY [766.030, 766.855] · SOXX [541.470, 547.910] · IWM [284.900, 286.330] · XLF [55.805, 56.205] · XLE [62.930, 63.700] · GLD [398.770, 400.220] · TLT [81.590, 81.730] · XBI [156.580, 159.040] · XRT [81.970, 82.585]. Breaking: **QQQ above its own high** ($731.30 vs $730.785, bull), SPY above ($767.00 vs $766.855, bull), SOXX above ($548.00 vs $547.910, bull), XLF below ($55.755 vs $55.805, bear), XRT below ($81.8323 vs $81.970, bear). **QQQ cleared 1.5× RVOL directly — ~1.99× at the 15-minute mark** (TLT also cleared directly at ~1.85× but sat exactly at its own $81.590 low, not breaking). Ranked: QQQ ~1.99×, TLT ~1.85×, XBI ~1.27×, SOXX ~1.24×, XLE ~1.16×, XLF ~0.87×, SPY ~0.88×, IWM ~0.84×, XRT ~0.45×, GLD ~0.47×. **QQQ is the only proxy clearing both step 1 (direct 1.5× clear, no fallback needed) and step 2 (real breakout above its own high)** — the cleanest signal this system has produced yet, no ambiguity, no marginal boundary case. Only one row qualified, so step 3 had nothing to rank against. Re-verified QQQ twice (review-time $731.195, pre-placement $731.3325, both above $730.785) — held both times. TLT re-checked too: sitting exactly at its own low, not breaking, correctly excluded. Profiled TQQQ on 30 daily sessions: stop 2.50%, target 3.75% (clamped, mfe_to_target 3.44 — likely unreachable per profile), stall 0.16%. Settled cash $503.86. `review_equity_order` clean, no alerts. Placed marketable limit buy, 6sh (floor(503.86/75.91)) @ $75.95 limit — **filled 6sh @ $75.9368**, favorable. Total cost $455.62. Placed protective stop_market at $74.04 (2.50% below fill) — confirmed resting. **Today's trade count: 1 of 3.** Intended exit: stop $74.04, ratchet per B2 as TQQQ runs, target ~$78.78 (+3.75%, likely unreachable per profile), same-day close by 11:00 regardless. Falsifiable pre-commit for 9:50: watch for QQQ reversing back below its own $730.785 opening-range high — a genuine, decisive move back inside the range, not noise at the boundary (per the standard established over the last several sessions).

**9:50 — MANAGE, position held, no reversal.** QQQ pre-commit not triggered — live $731.22, well above its $730.785 high, no reversal. TQQQ live $75.865, below entry fill $75.9368 — **profit gate closed, ratchet does not fire**, stop stays unconditionally at $74.04 per v3.63. Holding. Falsifiable pre-commit for 9:55: unchanged — QQQ back below $730.785, decisively.

**9:55 — MANAGE, position held, first ratchet.** QQQ extending further above its range — live $732.26, no reversal. TQQQ live $76.16, now above entry fill $75.9368 (in profit) — **profit gate open, ratchet fires.** `run_high` = $76.220 (1-min bars, 13:48-13:54 UTC). `candidate_stop` = $76.220 × (1 − 2×0.16%) = $75.9761 → $75.98. Live staleness check: live $76.16 > candidate — not stale, proceed. Cancelled the resting $74.04 stop (confirmed cancelled, no fill raced it), placed and confirmed a new stop at **$75.98**. Stop raised $74.04 → $75.98 on the first ratchet — already above the entry fill, locking in a small gain regardless of what happens next. Falsifiable pre-commit for 10:00: unchanged — QQQ back below $730.785, decisively.

**10:00 — MANAGE, position held, second ratchet.** QQQ still no reversal — live $732.61, extending further above its range. TQQQ live $76.285, still in profit — ratchet fires again. `run_high` = $76.390 (1-min bars, 13:54-14:01 UTC). `candidate_stop` = $76.390 × (1 − 2×0.16%) = $76.1456 → $76.15. Live staleness check: live $76.285 > candidate — not stale. Cancelled the resting $75.98 stop (confirmed cancelled, no fill raced it), placed and confirmed a new stop at **$76.15**. Stop raised $75.98 → $76.15. Position now +0.28% unrealized above the fill, trailing tighter as TQQQ climbs with QQQ's continued breakout. Falsifiable pre-commit for 10:05: unchanged — QQQ back below $730.785.

**10:05 — EXIT discovered, stop triggered cleanly on its own (checkpoint fired ~7min late).** Position check came back flat with no resting orders — the $76.15 stop had filled at 14:05:30 UTC, 6sh @ $76.15 exactly (two partial executions, 2sh+4sh). TQQQ dipped through the stop briefly before recovering — live price at this checkpoint read $76.36, back above the exit level. No manual intervention needed; the stop did its job on its own, same pattern as SOXL (9/16) and the second TMV trade (Friday). True MAE/MFE over the ~17-minute hold: true low $75.810 (13:50, six minutes after the fill, MAE +0.17%), true high $76.415 (14:01, MFE +0.63%) — the position ran well into profit before giving back a portion at the stop. Net: **+$1.28, +0.281%**, r=0.112 — a real winner, loss streak stays 0 of 3. Daily trade count stays 1 of 3 (exits don't add to the count). Logged to `archive/trades.csv`. Account now flat, $505.14. First live validation start-to-finish of a direct 1.5× RVOL clear (no fallback needed) carried through to a clean, winning exit — a useful contrast against the TLT-fallback trades of the prior two sessions. Checkpoint itself fired about 7 minutes late (scheduled 14:05:00Z, delivered 14:12:43Z) — not treated as missed since it did arrive and no capital was at risk in the gap (position had already closed on its own resting stop before the notification even landed).

**10:10 — ENTRY. Re-entered TQQQ, same QQQ signal, second trade of the day (checkpoint fired ~3min late).** SPY and SOXX still breaking bullish; XLE and GLD newly breaking bearish; XLF, IWM, TLT, XBI, XRT all inside their ranges. RVOL at the 40-minute mark, all under 1.5×: QQQ ~1.30× (top), XLE ~1.21×, SOXX ~0.93×, TLT ~0.92×, XBI ~0.81×, SPY ~0.59×, IWM ~0.57×, XLF ~0.53×, XRT ~0.52×, GLD ~0.50×. **v3.79 fallback: QQQ tops the ranking again and is still above its own $730.785 high** (live $733.32) — clears both steps, bullish, candidate TQQQ. **This is also a direct C12 step 0 case**: the just-closed TQQQ trade was profitable (+0.281%), so its own proxy (QQQ) qualifies for direct re-entry the moment it's still clearing all three C1 steps in the same direction — which it independently does anyway via the ordinary full-field read this checkpoint ran, so both paths agree. (Noting for the record: the mandatory T+0 immediate re-check technically should have run the same turn the exit was discovered at 10:05, not deferred to this regular 10:10 slot — but since the two are only 5 minutes apart under the uniform cadence, the result is identical either way.) Re-verified QQQ twice (review-time $733.36, pre-placement $733.36, both above $730.785) — held both times. Reused TQQQ's profile from the 9:45 entry (unchanged intraday: stop 2.50%, target 3.75%, stall 0.16%). Settled cash $505.14. `review_equity_order` clean, no alerts. Placed marketable limit buy, 6sh (floor(505.14/76.51)) @ $76.55 limit — **filled 6sh @ $76.5199**, favorable. Total cost $459.12. Placed protective stop_market at $74.61 (2.50% below fill) — confirmed resting. **Today's trade count: 2 of 3** — the 3rd would be discretionary per A1. Intended exit: stop $74.61, ratchet per B2, target ~$79.39 (+3.75%, likely unreachable per profile), same-day close by 11:00. Falsifiable pre-commit for 10:15: watch for QQQ reversing back below its own $730.785 opening-range high — a genuine, decisive move, same discipline as every prior trade this week.

**10:15 — MANAGE, position held, first ratchet.** QQQ still no reversal — live $733.73, extending further. TQQQ live $76.61, above entry fill $76.5199 (in profit) — **profit gate open, ratchet fires.** `run_high` = $76.6299 (1-min bar, 14:16 UTC). `candidate_stop` = $76.6299 × (1 − 2×0.16%) = $76.3846 → $76.38. Live staleness check: live $76.61 > candidate — not stale, proceed. Cancelled the resting $74.61 stop (confirmed cancelled, no fill raced it), placed and confirmed a new stop at **$76.38**. Stop raised $74.61 → $76.38 — already comfortably above the entry fill, locking in a gain. Falsifiable pre-commit for 10:20: unchanged — QQQ back below $730.785, decisively.

**10:20 — MANAGE, position held, ratchet skipped below minimum move.** QQQ no reversal — live $733.75. TQQQ live $76.635, still in profit. `run_high` advanced slightly to $76.650 (1-min bars, 14:16-14:20 UTC). `candidate_stop` = $76.650 × (1 − 2×0.16%) = $76.4048 → $76.40 — only a $0.02 (0.026%) move above the current $76.38 stop, well below TQQQ's own `min_stop_move_pct` of 0.38% from the profile. Per B2's minimum re-placement threshold, skipped the cancel/replace this checkpoint rather than churn the order for a move too small to matter — stop stays at $76.38. Falsifiable pre-commit for 10:25: unchanged — QQQ back below $730.785, decisively.

**10:25 — MANAGE, position held, ratchet still just under minimum move.** QQQ extending further, no reversal — live $734.54. TQQQ live $76.8601, continuing to run. `run_high` = $76.900 (1-min bars, 14:20-14:25 UTC). `candidate_stop` = $76.900 × (1 − 2×0.16%) = $76.6539 → $76.65 — a $0.274 (0.359%) move above the current $76.38 stop, still just under the 0.38% minimum, though converging fast (0.026% → 0.359% over the last two checkpoints). Skipped the cancel/replace again per B2 — stop stays at $76.38 for now, likely to clear the threshold next checkpoint if the run continues. Falsifiable pre-commit for 10:30: unchanged — QQQ back below $730.785, decisively.

**10:30 — MANAGE, position held, ratchet fires, clears the minimum move.** QQQ extending further, no reversal — live $734.955. TQQQ live $76.985, run continuing. `run_high` = $77.000 (1-min bars, 14:25-14:30 UTC). `candidate_stop` = $77.000 × (1 − 2×0.16%) = $76.7536 → $76.75 — a $0.37 (0.49%) move, clearing the 0.38% minimum as predicted last checkpoint. Live staleness check: live $76.985 > candidate — not stale. Cancelled the resting $76.38 stop (confirmed cancelled, no fill raced it), placed and confirmed a new stop at **$76.75**. Stop raised $76.38 → $76.75. Position now +0.61% unrealized above the fill. Falsifiable pre-commit for 10:35: unchanged — QQQ back below $730.785, decisively.

**10:35 — MANAGE, position held, ratchet below minimum move.** QQQ still extending, no reversal — live $735.185. TQQQ live $77.065, still running but the pace has slowed. `run_high` = $77.090 (1-min bars, 14:30-14:35 UTC). `candidate_stop` = $77.090 × (1 − 2×0.16%) = $76.8433 → $76.84 — only a $0.09 (0.12%) move above the current $76.75 stop, below the 0.38% minimum. Skipped the cancel/replace — stop stays at $76.75. Position now +0.69% unrealized above the fill. Falsifiable pre-commit for 10:40: unchanged — QQQ back below $730.785, decisively.

**10:40 — MANAGE, position held, ratchet still just under minimum, first real pullback.** QQQ still extending, live $735.25, no reversal. TQQQ peaked at a true high of $77.265 (14:37 UTC) then pulled back to live $77.08 — the first real give-back since entry, though still well above both the fill and the resting stop. `run_high` = $77.265. `candidate_stop` = $77.265 × (1 − 2×0.16%) = $77.0178 → $77.02 — a $0.268 (0.349%) move, just under the 0.38% minimum again. Skipped the cancel/replace — stop stays at $76.75. Position still +0.73% unrealized. Falsifiable pre-commit for 10:45: unchanged — QQQ back below $730.785, decisively.

**10:45 — MANAGE, position held, no new high, stop unchanged.** QQQ pulled back slightly to live $734.72 but remains well above its $730.785 high — no reversal. TQQQ live $76.929, continuing to consolidate below its true high; no new high in the 14:40-14:45 bars (max $77.150, below the standing `run_high` of $77.265) — `run_high` stays unchanged, so `candidate_stop` is unchanged too, still under the minimum move. Stop stays at $76.75. Position still +0.53% unrealized. Falsifiable pre-commit for 10:50: unchanged — QQQ back below $730.785, decisively.

**10:50 — MANAGE, position held, no new high, stop unchanged.** QQQ live $734.815, still well above its $730.785 opening-range high — no reversal. TQQQ live $76.970, up from entry $76.52 (+0.59% unrealized). 14:37–14:49 bars show no new high above the standing `run_high` of $77.265 (max in window $77.150 at 14:41) — `run_high` stays unchanged, `candidate_stop` unchanged, still under the minimum move. Stop confirmed still resting at $76.75 (order `6ab13f9c`, state confirmed). Falsifiable pre-commit for 10:55: unchanged — QQQ back below $730.785, decisively.

**10:55 — MANAGE, position held, no new high, stop unchanged.** QQQ live $735.152, still well above its $730.785 opening-range high — no reversal. TQQQ live $77.060, up from entry $76.52 (+0.71% unrealized). 14:49–14:54 bars show no new high above the standing `run_high` of $77.265 (max in window $77.085 at 14:49) — `run_high` stays unchanged, `candidate_stop` unchanged, still under the minimum move. Stop stays at $76.75. Last entry-eligible slot of the day (C9) — moot, position already open, no new entry considered. Falsifiable pre-commit for 11:00: unchanged — QQQ back below $730.785, decisively; 11:00 is the close checkpoint regardless (B4/v3.77).

**11:00 — CLOSE (double duty, B2/v3.58). Final ratchet, then direct market sell. TQQQ trade #2 closed, real winner.** QQQ live $735.885, never reversed below its $730.785 opening-range high at any point in the hold. TQQQ made one final new high in the 14:54-14:59 bars (max $77.280 at 14:58) — `run_high` advanced 77.265 to 77.280, but the resulting `candidate_stop` ($77.03) was still under the 0.38% `min_stop_move_pct` threshold relative to the resting $76.75 stop, so the ratchet correctly skipped (no churn right before the close). No B3 exit fired — no reversal, no headline — so the close is purely structural (B4: every position closes the same day, enforced at 11:00). Cancelled the resting $76.75 stop and sold 6sh at market — filled in one execution at **$77.2638**, no ratchet-then-gap, no stop-pin attempt. Entry was $76.5199 (10:16:01 ET); net **+$4.46, +0.972%, r=0.389** — a real winner. True MAE/MFE from 1-min bars over the ~46-minute hold: low $76.500 (at/near the fill), high $77.300 (one minute before the close fill) — the close captured nearly the full run.

**D3 report.** Account total_value **$509.60**. Today's realized P&L $5.74 across 2 trades (TQQQ #1 +$1.28, TQQQ #2 +$4.46) — both real winners, no losses today. Loss streak: **0 of 3**, breaker not tripped. Daily trade count: **2 of 3** for the day — stopped short of the 3rd discretionary slot; nothing else cleared the gate by 10:55. Total all-time realized P&L $9.64. Deposited capital recomputed: $509.60 minus $9.64 minus $0 unrealized (flat) = **$499.96**, unchanged. Floor **$250.00**, unchanged. Account flat, no resting orders. trades.csv row appended for this exit.

**Primary arming (D1) — Tuesday 2026-09-22's full 19-slot grid armed now** (no weekend to skip): 9:00, 9:30, 9:45, 9:50–10:55 every 5 min, 11:00 close, 8:00pm backup.

**Post-close, same session — v3.80 rule change, direct governor instruction.** Following a review of the day (requested by the governor: what went well/wrong, and how well-timed was the entry relative to QQQ's actual move), two rules changed: (1) the structural close extends from 11:00 to 12:00 ET, reversing v3.77's tightening — prompted by 9/17–9/21 all showing continuation past the old 11:00 close with no reversal example on record, and by today specifically: TQQQ ran another ~2.3% past the 11:00 exit into the afternoon; (2) the discretionary 3rd trade, once today's count is already 2, is now restricted to re-entering an instrument already traded today that was stopped out clean (not a fresh candidate) — prompted directly by today's TQQQ stop-out at 10:05 (+0.281%, a real win) on ordinary chop right before the move resumed. Full rule text in A1/B2/B4/C9/C12/D1; version note at v3.80. **Tuesday 2026-09-22's grid was re-armed from scratch under the new schedule** — the 19-slot grid above is now superseded: all 19 of those triggers were deleted and replaced with the new 31-slot grid (9:00, 9:30, 9:45, 9:50–11:55 every 5 min, 12:00 close, 8:00pm backup), confirmed via `list_triggers`.
