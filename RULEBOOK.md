...
**Friday 2026-09-25, 9:00 research.** Thursday's full session (1 trade, FAZ off an XLF/financials signal that took 90 minutes to resolve two whipsaw tests before finally breaking: net +$0.46, +0.093%, r=0.037, a marginal real winner) archived in `archive/trades.csv` and git history — not restated in full here. **Correction from last night's close entry: that report stated the loss streak stayed at "1 of 3" after the FAZ win — wrong. Per E1's own rule ("a winner or a scratch anywhere resets to zero"), a real win resets the streak outright.** FAZ's positive P&L (+0.093%) resets it to **0 of 3**, not 1. The error was confined to prose commentary in E5 and `trades.csv`'s notes field — no numeric/structural field was wrong (`counts_toward_streak=yes` is correct), and the streak itself is always recomputed fresh from the trade log per checkpoint, never read from a cached number, so nothing downstream was actually misled by it. Caught and corrected here, first checkpoint after the error, per this file's own "catch your own errors before they compound" discipline.

- **A1 checks: loss streak 0 of 3** (corrected — see above; FAZ's real win resets it). **Position: flat, no resting orders** (`get_equity_positions` empty, `get_equity_orders` confirmed state empty). **Daily trade count today: 0 of 3** (fresh day). **Per-instrument 2-entry cap (v3.83): no instrument has been touched today yet — full field open.**
- **Account state:** total value/cash/buying power **$511.26** (`get_portfolio`), unchanged from yesterday's close. **Deposited capital recomputed**: `$511.26 − $11.34 (all-time realized P&L, get_realized_pnl) − $0 unrealized` = **$499.92**, unchanged. **Floor: $249.96** (50% of deposited), confirmed live this checkpoint.
- **Headlines/macro:** Risk-on morning, a reversal from the last two sessions. Futures broadly higher on Iran's offer to reopen the Strait of Hormuz and resume nuclear talks within seven days (conditional on US agreement to prior MOU terms) — Dow +0.36%, S&P +0.37%, Nasdaq 100 +0.66%, Russell 2000 +0.4% premarket. The 10-year Treasury yield sits at **~5.175%**, still elevated but off this week's 19-year highs — one read (Schwab) flagged a pullback to ~4.93% yesterday as a possible sign the bond market is settling with the Fed's hawkish stance, though this morning's quoted level is back near 5.17-5.18%, so treat the "cooling" read cautiously pending a live check. Markets pricing ~66% odds of another Fed hike in October. **Today's catalysts:** durable goods orders (8:30am ET) and University of Michigan consumer sentiment (10am ET) — both land mid-morning, inside the entry window. Costco (not Core Ten, XRT-adjacent) beat this morning (EPS $6.75 vs. ~$6.52 est.) but traded slightly lower pre-market. Akamai up ~23% pre-market on an $11.6B Anthropic infrastructure deal — unrelated to any Core Ten theme, noted only as a sign of continued AI-infrastructure risk appetite. No Core Ten-relevant earnings today. ([Benzinga](https://www.benzinga.com))
- **Pre-market prices, the ten proxies — C1's actual gate surface, none of this is a decision yet (RVOL/ORB can't complete before 9:45), vs yesterday's official close:** QQQ $743.83 (+0.37%) · SPY $769.26 (+0.27%) · SOXX $572.15 (**+1.07%, the sharpest move of the ten — a reversal from two straight days of chip weakness**) · IWM $282.34 (+0.24%) · XLF $54.70 (+0.31%) · XLE $61.93 (**-1.07%, the lone proxy trading lower pre-market**, WTI crude down ~1.9-2% on Hormuz-reopening optimism easing supply-risk pricing — a notable flip from XLE's role as the lone upside leader the last two sessions) · GLD $394.07 (+0.61%) · TLT $79.51 (+0.11%) · XBI $156.91 (+0.55%) · XRT — no fresh pre-market print yet, quote timestamp matches yesterday's official close, flagged stale. A broadly risk-on morning with semis the clear outlier to the upside and energy the clear outlier to the downside — a near-mirror of Wednesday/Thursday's pattern.
- **Pre-market context on the twenty leveraged tickers (not gated, informational only, C4):** TQQQ $79.398/SQQQ $33.84 (+1.04%/-1.00%) · UPRO $151.19/SPXU $33.85 (+0.80%/-0.73%) · SOXL $150.83/SOXS $32.62 (**+3.07%/-3.00%, by far the sharpest move of the field**, tracking SOXX's own reversal to the upside) · TNA $60.60/TZA $45.23 (+0.68%/-0.62%) · FAS $151.2635/FAZ ~$36.79 (+0.80%/~-0.81%, FAZ's own premarket print stale — timestamped overnight — indicative only from the bid/ask midpoint) · ERX $102.51/ERY $9.34 (-1.32%/+2.19%, ERX quote somewhat stale, ~8:01am ET) · UGL $48.99/GLL $23.3415 (+1.11%/-1.21%) · TMF $27.38/TMV $46.8461 (+0.11%/-0.07%) · LABU $260.68/LABD $7.18 (+1.31%/-0.97%) · RETL $7.107/SZK — no fresh premarket print, flagged stale.
- Earnings: Tamboran Resources (TBN) reported this morning, a beat, not a Core Ten theme. Costco reported this morning (also not Core Ten, noted above). No other Core Ten-relevant reports today.
...
**Watch list for 9:45, based on pre-market only (not a qualification, C1 can't run yet):** SOXX/semis is the standout again, but flipped — a real reversal to the upside after two sessions of weakness that produced Wednesday's SOXS trades. If it holds into the open, today's first signal could be a SOXL candidate, the opposite side of the same theme. XLE is worth watching for the same reason in reverse — it led to the upside the last two sessions and is now the lone laggard on falling crude. No instrument carries any residual state from yesterday (FAZ's 2-entry cap and decay-ceiling checks don't apply — fresh day, fresh field).

**9:30 observation**: A1 re-checked — loss streak still **0 of 3**, flat, no resting orders, daily trade count still **0 of 3**, no instrument at its 2-entry cap. **B6 opening-range tracker initialized on the ten proxies** — each proxy's 9:30 print is the baseline C1 step 2 will check the 9:45 breakout against, vs yesterday's close: QQQ $742.17 (+0.14%) · SPY $767.78 (+0.08%) · SOXX $569.62 (**+0.63%, still the sharpest move of the ten**, holding its pre-market strength into the open) · IWM $282.15 (+0.17%) · XLF $54.65 (+0.22%) · XLE $61.93 (**-1.07%, still the lone proxy trading lower**) · GLD $391.81 (+0.03%) · TLT $79.36 (-0.08%) · XBI $156.735 (+0.44%) · XRT $82.19 (+0.11%, first real print of the session — the earlier stale pre-market quote is superseded). The pre-market pattern held cleanly into the open — SOXX/semis still the clear leader, XLE still the clear laggard. No decision made here — first real gate run is 9:45.

**9:45 — NO ENTRY. TLT clears 1.5× RVOL directly but the "breakout" is boundary noise, not a real break — a correct, ordinary no-trade outcome (C5).** RVOL (20-day average volume at this same time-of-day, fresh-computed from 5-min bars): **TLT ~1.564×, clearing the bar directly — no fallback needed.** Rest of field, for the record: XLF ~1.096× · IWM ~1.095× · QQQ ~0.872× · XLE ~0.873× · GLD ~0.852× · XBI ~0.804× · SPY ~0.760× · TLT's own clear leaves nothing else checked at step 2 · XRT ~0.475× · SOXX ~0.499× (**worth flagging: SOXX was the sharpest price mover pre-market and at the open, +0.63%, but its RVOL is actually the second-lowest in the field — another case of a real price move on unremarkable relative volume, same shape as Thursday's SOXX read**). **Step 2: TLT's own 9:30-9:45 opening range is [$79.3031, $79.460]** (from today's three 5-min bars). Three live reads: $79.310 (inside), then $79.305 twice more, stable — **$0.0019 below the low, a fraction of a cent, not a genuine decisive break** — the same "noise at the boundary" standard applied to XLF's chop this week (a real break needs to be a real break, not a rounding-scale brush). No candidate this checkpoint. No trade. Falsifiable watch for 9:50: TLT clearing meaningfully below $79.3031, sustained across multiple reads and by more than a token amount, or SOXX's RVOL catching up to its own price move.

**9:50 — NO ENTRY, still flat. C1 re-run fresh, TLT drops back below 1.5×, still no real break.** RVOL: **TLT ~1.465×**, back under the bar — v3.79 fallback carries it alone into step 2 again (still top of the ranking): IWM ~1.004× · XLE ~0.973× · XLF ~0.956× · QQQ ~0.852× · GLD ~0.825× · SPY ~0.814× · XBI ~0.743× · SOXX ~0.475× · XRT ~0.378×. Step 2: TLT's range [$79.3031, $79.460] still holds — live $79.300, stable across two reads, still only ~$0.003 below the low — the same rounding-scale margin as 9:45, not a genuine break. No candidate, no trade. Falsifiable watch for 9:55: TLT clearing meaningfully below $79.3031, sustained and by more than a token amount.

**9:55 — ENTRY. First trade of the day: TMV, bearish leg off TLT, RVOL fallback continuing but breakout finally confirmed decisive.** RVOL: **TLT ~1.376×**, continuing to cool but still top of the fallback ranking: XLE ~1.069× · IWM ~0.971× · XLF ~0.866× · SPY ~0.849× · QQQ ~0.836× · GLD ~0.835× · XBI ~0.767× · SOXX ~0.440× · XRT ~0.349×. **Step 2: TLT's fixed 9:30-9:45 opening range [$79.3031, $79.460]** — after two checkpoints of rounding-scale brushes below the low (9:45, 9:50), live price broke meaningfully at 9:55: three consecutive reads $79.275 / $79.275 / $79.275 (bid $79.27, ask $79.28), then confirmed extending to $79.255 immediately pre-placement — **2.8-6.5 cents below the low, a real decisive break**, not the earlier noise. Bearish, candidate **TMV** (Treasury Bonds inverse, 3x). Only TLT ever qualified for step 2 today, so step 3 (ATR-expansion) had nothing to rank against — same single-candidate shape as prior entries. Profiled TMV on 37 daily sessions (`tools/profile.py`): stop 2.50%, target 3.75%, stall 0.11%, min_stop_move 0.20%, mfe_to_target 4.97 (**well above the 2.50 ceiling — target effectively unreachable per B1's own flag, informational only, doesn't block entry**). 2-of-3 Hindsight Rule: 2 prior closed TMV trades on record (9/18, a scratch via stop trigger and a win via eod close) — only 1 of them exited by the ratchet stop, short of the ≥2 needed — multiplier stays at the 2× baseline. Tradability confirmed (individual account, regular-hours tradeable). Settled cash $511.26. `review_equity_order` clean, no alerts, quote $47.25×300 / $47.26×200. Re-checked TLT immediately before placement — live $79.255, still decisively below $79.3031, extending. Placed marketable limit buy, 10sh (floor(511.26/47.35)) @ $47.35 limit — **filled 10sh @ $47.2662**, favorable (8.4¢ better than the limit). Total cost $472.66. Placed protective stop_market at $46.08 (2.50% below fill) — confirmed resting. **Today's trade count: 1 of 3.** Intended exit: stop $46.08, ratchet per B2 as TMV runs, target ~$49.04 (+3.75%, though B1's own flag says this is unlikely to be reached given the historical mfe_to_target ratio), same-day close by 12:00 (v3.80). Falsifiable pre-commit for 10:00: watch for TLT reclaiming back above its own $79.3031 opening-range low, decisively.
