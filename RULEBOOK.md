...
**Wednesday 2026-09-23, 9:00 research — second live day under v3.80.** Tuesday's full session (2 trades, both ERX off the same XLE signal — a clean stop-out win at 10:25, then a direct-market-sell close at 12:00 with the position still running, net +$7.36; first full day validating the extended close) archived in `archive/trades.csv` and git history — not restated here. Housekeeping: the file's top-of-document version banner still read "3.79" this checkpoint despite v3.80 being live since Monday's close — corrected to 3.80, no rule content changed.

- **A1 checks: loss streak 0 of 3** (Tuesday's two trades were both real winners). **Position: flat, no resting orders** (`get_equity_positions` empty, `get_equity_orders` confirmed state empty). **Daily trade count today: 0 of 3** (fresh day).
- **Account state:** total value/cash/buying power **$516.96** (`get_portfolio`), unchanged from Tuesday's close. **Deposited capital recomputed**: `$516.96 − $17.00 (all-time realized P&L, get_realized_pnl) − $0 unrealized` = **$499.96**, unchanged. **Floor: $250.00** (50% of deposited), confirmed live this checkpoint.
- **Headlines/macro:** Cautious, Fed-driven morning. Futures ticked lower overnight (S&P -0.1%, Nasdaq-100 -0.2%, Dow -0.2%) as Treasury yields and oil firmed, though the cash open showed early stabilization (SPY +0.09% at the open per Schwab). **Today's real catalyst is two Fed speeches at 10:05 and 10:20 ET** — Boston Fed's Collins already flagged "an increased likelihood" inflation stays "notably" above the 2% target, a hawkish-leaning note worth watching directly against the Treasury Bonds theme (TLT/TMF/TMV). Cintas and General Mills reported earnings this morning — neither touches a Core Ten theme. AI capex story continues in the background (hyperscaler spend ~$800B this year) but nothing immediately actionable pre-market. ([Yahoo Finance](https://finance.yahoo.com/markets/live/stock-market-today-wednesday-september-23-dow-sp-500-nasdaq-080556640.html), [CNBC](https://www.cnbc.com/2026/09/22/stock-market-today-live-updates.html))
- **Pre-market prices, the ten proxies — C1's actual gate surface, none of this is a decision yet (RVOL/ORB can't complete before 9:45), vs Tuesday's official close:** QQQ $745.81 (-0.22%) · SPY $772.63 (-0.10%) · SOXX $566.62 (-1.08%, a second straight morning of chip weakness) · IWM $285.82 (-0.48%) · XLF $54.67 (-0.24%) · XLE $62.21 (**+0.70%, the lone proxy trading higher pre-market**, extending Tuesday's own XLE/ERX strength) · GLD $394.89 (-1.29%, gold's sharpest pre-market pullback of the ten) · TLT $81.41 (-0.42%, notable given today's Fed-speech calendar) · XBI $161.54 (-0.20%) · XRT $83.65 (no fresh pre-market print yet as of this checkpoint — last trade stamped Tuesday's 4pm close, flagged stale rather than treated as a real quote). A broadly soft, risk-off-leaning morning with energy the one clear outlier to the upside.
- **Pre-market context on the twenty leveraged tickers (not gated, informational only, C4):** TQQQ $80.15/SQQQ $33.53 (-0.84%/-0.71%) · UPRO $153.24/SPXU $33.37 (-0.50%/-0.86%) · SOXL $146.88/SOXS $33.51 (**-3.34%/+3.36%, sharpest move of the field**, tracking SOXX's own pullback) · TNA $62.95/TZA $43.61 (-1.46%/+1.44%) · FAS $152.11/FAZ $36.91 (-0.26%/+0.90%, FAS quote stamped ~8:14am ET, slightly stale) · ERX $102.69/ERY $9.29 (+1.32%/-0.98%, ERX quote stamped ~8:07am ET and spread unusually wide, bid $101.00/ask $103.74 — stale and thin, treat pre-market level as indicative only) · UGL $49.31/GLL $23.27 (-2.51%/+2.78%) · TMF $29.48/TMV $43.64 (-1.27%/+1.23%) · LABU $288.19/LABD $6.63 (-0.28%/+1.11%, LABU quote stamped ~7:29am ET, stale) · RETL $7.68/SZK $22.18 (+2.13% on an overnight 1:50am ET print, stale; SZK's own previous-close field looks inconsistent with its official close price, likely a distribution adjustment — flagged, not resolved, watch for a cleaner read once real premarket volume starts).
- Earnings: Cintas and General Mills reported this morning; neither lands on a Core Ten theme.
...
**Watch list for 9:45, based on pre-market only (not a qualification, C1 can't run yet):** XLE is the one proxy already trading in the direction Tuesday's signal ran, worth watching first at the open. SOXX's pullback is sharp enough that a bearish SOXL/SOXS breakout is plausible if it holds into the 9:30-9:45 range. TLT bears watching given the two scheduled Fed speeches mid-morning.

**9:30 observation**: A1 re-checked — loss streak still **0 of 3**, flat, no resting orders, daily trade count still **0 of 3**. **B6 opening-range tracker initialized on the ten proxies** — each proxy's 9:30 print is the baseline C1 step 2 will check the 9:45 breakout against, vs Tuesday's close: QQQ $746.96 (-0.07%) · SPY $772.97 (-0.05%) · SOXX $570.99 (-0.31%, off its sharper pre-market low) · IWM $286.07 (-0.40%) · XLF $54.59 (-0.38%) · XLE $62.05 (**+0.44%, still the lone proxy trading higher**) · GLD $395.37 (-1.17%) · TLT $81.505 (-0.30%) · XBI $162.00 (**+0.08%, the only other proxy in the green**, reversing its earlier pre-market softness) · XRT $83.41 (-0.31%, first real print of the session — the earlier "stale" pre-market quote is superseded). The pre-market pattern mostly held into the open — XLE still the clear leader to the upside, broad softness elsewhere — with XBI notably flipping from a small pre-market decline to a small gain. No decision made here — first real gate run is 9:45.

**9:45 — ENTRY. First trade of the day: SOXS, bearish leg off SOXX, direct RVOL clear (no fallback needed).** Fixed 9:30-9:45 opening range (1-min bars, cumulative volume and range both freshly computed, never cached): QQQ [744.45, 747.12] · SPY [771.89, 773.02] · SOXX **[563.97, 571.55]** · IWM [284.34, 286.17] · XLF [54.465, 54.915] · XLE [62.05, 62.385] · GLD [393.03, 395.50] · TLT [81.330, 81.505] · XBI [160.00, 162.68] · XRT [82.775, 83.56]. RVOL ranked (20-day avg daily volume vs. today's 15-min cumulative, both fresh): **SOXX ~3.26× — clears 1.5× directly, no fallback triggered.** (For the record, the rest of the field: XLF ~1.30×, XLE ~1.00×, IWM ~0.94×, XBI ~0.76×, QQQ ~0.75×, GLD ~0.58×, XRT ~0.56×, SPY ~0.36×, TLT ~0.35× — none of them get checked at step 2 since one proxy already cleared 1.5× outright.) **Step 2: SOXX broke decisively below its own $563.97 opening-range low** — live $563.285 at 13:47:35 UTC, confirmed again at $563.51 moments later and a third time at $563.51 immediately pre-placement — bearish, candidate **SOXS**. Only one proxy cleared both steps, so step 3 (ATR-expansion) had nothing to rank against — same shape as Tuesday's 9:50 ERX entry. SOXX's own huge RVOL (3.26×, more than double the next-highest proxy) lines up with the sharp pre-market/open semiconductor weakness flagged at 9:00 and 9:30 — a real signal, not noise, in contrast to yesterday's razor-thin fallback picks. Profiled SOXS on 29 daily sessions (tools/profile.py): stop 3.49%, target 5.23%, stall 0.45%, min_stop_move 0.58%. 2-of-3 Hindsight Rule: no prior closed SOXS trades on record (one prior SOXL trade, 9/16, a different ticker on the same row — doesn't count per-ticker) — multiplier stays at the 2× baseline. Tradability confirmed (individual account, regular-hours tradeable). Settled cash $516.96 (unsettled funds $0). `review_equity_order` clean, no alerts, quote $33.93×1100 / $33.95×3800. Placed marketable limit buy, 15sh (floor(516.96/34.05)) @ $34.05 limit — **filled 15sh @ $34.0099**, favorable (4.4¢ better than the limit). Total cost $510.15. Placed protective stop_market at $32.83 (3.49% below fill) — confirmed resting. **Today's trade count: 1 of 3.** Intended exit: stop $32.83, ratchet per B2 as SOXS runs, target ~$35.79 (+5.23%, reachable per profile — mfe_to_target 1.74, well under the 2.50 ceiling, unlike ERX's two trades), same-day close by 12:00 (v3.80). Entry+5 catch-up check moot — next grid slot (9:50) is already ≤5 minutes out. Falsifiable pre-commit for 9:50: watch for SOXX reclaiming back above its own $563.97 opening-range low — a genuine, decisive move, not noise at the boundary.

**9:50 — MANAGE, position held, first ratchet, profit gate open on the very first check.** SOXX live $563.05, still below its $563.97 low — no reversal. SOXS live $34.040, above the $34.0099 entry fill. **Profit gate open, ratchet fires.** `run_high` = $34.110 (1-min bar spanning the fill, 13:48 UTC), up from the initialized $34.0099. `candidate_stop` = $34.110 × (1 − 2×0.45%) = $33.8030 → $33.80. Live staleness check: live $34.040 > candidate — not stale. Min-stop-move check: $33.80 vs current $32.83 is a $0.97 (2.96%) move, well clear of SOXS's 0.58% minimum. Cancelled the resting $32.83 stop (confirmed cancelled, no fill raced it), placed and confirmed a new stop at **$33.80**. Stop raised $32.83 → $33.80. Position now +0.089% unrealized. Falsifiable pre-commit for 9:55: watch for SOXX reclaiming back above its own $563.97 opening-range low, decisively.

**9:55 — MANAGE, position held, profit gate closed, no ratchet despite a new high in between.** SOXX live $563.59, still below its $563.97 low — no reversal. SOXS ran to a new high since the last checkpoint — `run_high` would advance to $34.370 (1-min bar, 13:52 UTC) — but pulled back hard since, live now $33.955, **below the $34.0099 entry fill**. **Profit gate closed per v3.63**, stop stays unconditionally at $33.80 regardless of `run_high`'s advance. Live price is still $0.155 above the resting stop, not near triggering. Position essentially round-tripped from +1.06% (at the $34.37 peak) back to -0.16% unrealized inside five minutes. Falsifiable pre-commit for 10:00: watch for SOXX reclaiming back above its own $563.97 opening-range low, decisively.

**10:00 — EXIT discovered, stop triggered cleanly on its own. A SCRATCH, not a real loss.** Position check came back flat — the $33.80 stop had filled at 14:00:13 UTC, 15sh @ **$33.80** exactly, no exit slippage. SOXS had run to a true high of $34.370 (13:52 UTC) before reversing hard and continuing down through the stop. True MAE/MFE over the ~12-minute hold: true low $33.720 (14:00 UTC, same minute as the exit, MAE 0.852%), true high $34.370 (MFE 1.059%). Net: **-$3.17, -0.617%**, r=-0.177. **-0.617% is better than E1's -1.0% loss threshold — this is a scratch, not a real loss.** Loss streak stays **0 of 3** (a scratch resets it exactly like a winner would). Daily trade count stays 1 of 3 (exits don't add to the count). Logged to `archive/trades.csv`. Account now flat, $513.79.

**C12 re-entry check (T+0, same turn — doubles as the regular 10:00 checkpoint).** Step 0 doesn't apply (exit wasn't profitable). Full field re-run at the ~32-minute mark: RVOL re-ranked (fresh computed): **SOXX still the sole proxy clearing 1.5× directly (~2.56×**, down from 3.26× at entry but still well clear of the bar), XLF ~1.24×, IWM ~0.78×, XBI ~0.91×, XLE ~0.92×, TLT ~0.86×, QQQ ~0.74×, GLD ~0.54×, XRT ~0.42×, SPY ~0.43×. **SOXX has moved back inside its own opening range** — live $564.12, above the $563.97 low (fails the bearish test) and well below the $571.55 high (fails the bullish test too) — no breakout either direction, fails step 2. No candidate. No other proxy cleared 1.5× RVOL. **No re-entry.** Worth noting plainly: SOXX stayed below its own OR low through 9:59 (closest approach $563.86 at 9:58) and only crossed back above it inside the same one-minute bar the stop fired in (13:59 close $563.31 → 14:00 bar opened $563.38, closed $564.66) — the exact order of the stop fill versus the crossing isn't resolvable from minute-bar data, but both happened in the same 60-second window: the stop and the setup's own invalidation arrived together, not a case of a stop firing ahead of price that later proved it wrong. Also worth noting for v3.80 purposes: since this exit is a scratch (not a real loss under E1), SOXS is **not** excluded from re-entry today under v3.68 — it remains eligible for a later 3rd-trade re-entry if today's count reaches 2 and this was one of the two. T+10 (14:10:13) lands 13 seconds after the already-armed 10:10 regular grid checkpoint — no separate ad hoc trigger armed; 10:10 will itself serve double duty as the T+10 check given the negligible gap. Resume the regular grid at 10:05.

**10:05 — ENTRY. Second trade of the day: SOXS again, same signal, fresh re-break of SOXX's opening-range low.** RVOL re-ranked at the 35-minute mark (fresh computed): **SOXX still the sole proxy clearing 1.5× directly (~2.48×**, continuing to cool from 3.26× at entry but still well clear), XLF ~1.22×, TLT ~0.82×, XBI ~0.85×, XLE ~0.88×, IWM ~0.76×, QQQ ~0.73×, GLD ~0.54×, XRT ~0.45×, SPY ~0.43×. **SOXX broke back below its own $563.97 opening-range low** — confirmed on three separate live reads in the space of a minute (live $563.52, then $563.02, then $562.95, all below $563.97) — bearish, candidate SOXS again. **Flagging plainly for the record: this boundary has whipsawed hard over the last ten minutes** — SOXX traded below $563.97 through 9:59, crossed above it around 10:00-10:04 (peaking $565.02 at 10:01, still $564.22 as late as 10:05's own bar), then broke back below it again in the last two minutes before this checkpoint. This is the same "razor-thin, noise-at-the-boundary" shape flagged before on other tickers (XLF's $55.59 vs $55.580 on 9/22) — the rule was followed exactly as written (no discretionary override exists for a whipsawing boundary), but it's a real risk this re-entry chops the same way the first one did. Reused SOXS's profile from the 9:45 entry, unchanged (stop 3.49%, target 5.23%, stall 0.45%, min_stop_move 0.58%). 2-of-3 Hindsight Rule: only 1 prior closed SOXS trade on record (today's scratch) — count condition needs at least 2 of the last 3, doesn't have the data — multiplier stays at the 2× baseline. Settled cash $513.79. `review_equity_order` clean, no alerts, quote $34.05×1800 / $34.06×800. Placed marketable limit buy, 15sh (floor(513.79/34.12)) @ $34.12 limit — **filled 15sh @ $34.09**, favorable (3¢ better than the limit). Total cost $511.35. Placed protective stop_market at $32.90 (3.49% below fill) — confirmed resting. **Today's trade count: 2 of 3** — at the recommended pace, a 3rd trade today would be discretionary and, per v3.80, restricted to re-entering a clean stopped-out instrument from today (this trade or the first one) if either clears the gate again. Intended exit: stop $32.90, ratchet per B2, target ~$35.87 (+5.23%), same-day close by 12:00 (v3.80). Falsifiable pre-commit for 10:10: watch for SOXX reclaiming back above its own $563.97 opening-range low, decisively — given the whipsaw, weight this pre-commit less confidently than usual.

**10:10 — MANAGE, position held, ratchet fires, whipsaw resolved decisively in the position's favor.** SOXX live $560.29, well below its $563.97 low — no reversal, the boundary chop from 10:00-10:05 has resolved cleanly downward, extending, not reverting. SOXS live $34.52, well above the $34.09 entry fill. **Profit gate open, ratchet fires.** `run_high` = $34.430 (1-min bar, 14:10 UTC), up from the initialized $34.09. `candidate_stop` = $34.430 × (1 − 2×0.45%) = $34.1202 → $34.12. Live staleness check: live $34.52 > candidate — not stale. Min-stop-move check: $34.12 vs current $32.90 is a $1.22 (3.71%) move, well clear of the 0.58% minimum. Cancelled the resting $32.90 stop (confirmed cancelled, no fill raced it), placed and confirmed a new stop at **$34.12** — already above the entry fill, one checkpoint after entry. Stop raised $32.90 → $34.12. Position now +1.26% unrealized. Note: the earlier scratch's C12 T+10 check is now moot — a fresh position is already open from the 10:05 re-entry, superseding that cycle. Falsifiable pre-commit for 10:15: watch for SOXX reclaiming back above its own $563.97 opening-range low, decisively.

**10:15 — MANAGE, position held, ratchet fires again.** SOXX live $559.95, still well below its $563.97 low — no reversal, continuing to extend. SOXS live $34.55, well above the $34.09 entry fill. **Profit gate open, ratchet fires.** `run_high` = $34.730 (1-min bar, 14:13 UTC), up from $34.430. `candidate_stop` = $34.730 × (1 − 2×0.45%) = $34.4152 → $34.42. Live staleness check: live $34.55 > candidate — not stale. Min-stop-move check: $34.42 vs current $34.12 is a $0.30 (0.879%) move, well clear of the 0.58% minimum. Cancelled the resting $34.12 stop (confirmed cancelled, no fill raced it), placed and confirmed a new stop at **$34.42**. Stop raised $34.12 → $34.42. Position now +1.35% unrealized. Falsifiable pre-commit for 10:20: watch for SOXX reclaiming back above its own $563.97 opening-range low, decisively.

**10:20 — MANAGE, position held, ratchet fires, approaching target.** SOXX live $558.47, still well below its $563.97 low — no reversal, extending further. SOXS live $34.81, well above the $34.09 entry fill. **Profit gate open, ratchet fires.** `run_high` = $35.060 (1-min bar, 14:20 UTC), up from $34.730. `candidate_stop` = $35.060 × (1 − 2×0.45%) = $34.7445 → $34.74. Live staleness check: live $34.81 > candidate — not stale. Min-stop-move check: $34.74 vs current $34.42 is a $0.32 (0.930%) move, well clear of the 0.58% minimum. Cancelled the resting $34.42 stop (confirmed cancelled, no fill raced it), placed and confirmed a new stop at **$34.74**. Stop raised $34.42 → $34.74. Position now +2.13% unrealized — `run_high` ($35.06) is now within striking distance of the informational target (~$35.87). Falsifiable pre-commit for 10:25: watch for SOXX reclaiming back above its own $563.97 opening-range low, decisively.
